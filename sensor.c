...
void sensor_node_init(void)
{
   ...
   * 2. Present ambient temperature property (property ID: 0x004F)
...
{
  log("evt:gecko_evt_mesh_sensor_server_get_request_id\r\n");
...
{
  log("evt:gecko_evt_mesh_sensor_server_get_column_request_id\r\n");
...
{
  log("evt:gecko_evt_mesh_sensor_server_get_series_request_id\r\n");
...
{
  log("evt:gecko_evt_mesh_sensor_server_get_cadence_request_id\r\n");
...
{
  log("evt:gecko_evt_mesh_sensor_server_set_cadence_request_id\r\n");
  gecko_cmd_mesh_sensor_setup_server_send_cadence_status(SENSOR_ELEMENT,
                                                         pEvt->client_address,
                                                         pEvt->appkey_index,
                                                         NO_FLAGS,
...
{
  log("evt:gecko_evt_mesh_sensor_server_get_settings_request_id\r\n");
...
{
  log("evt:gecko_evt_mesh_sensor_server_get_setting_request_id\r\n");
