...
#define BSP_SERIAL_APP_CTS_LOC                        (13U)

#define BSP_SERIAL_APP_RTS_PIN                        (5U)
#define BSP_SERIAL_APP_RTS_PORT                       (gpioPortF)
#define BSP_SERIAL_APP_RTS_LOC                        (13U)
*/
...
#define BSP_SPIDISPLAY_USART                          (HAL_SPI_PORT_USART1) //(HAL_SPI_PORT_USART1)
...
#define BSP_USART1_SPI_SPEED        1000000 // 1M   Richard
